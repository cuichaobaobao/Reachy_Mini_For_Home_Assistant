...
from reachy_mini_home_assistant.protocol import satellite, voice_pipeline
from reachy_mini_home_assistant.protocol.satellite import VoiceSatelliteProtocol
